// Problem link https: https://bit.ly/3xj4WqR
// This is must problem for Recursion Understanding
...
/*
    Revision Points: 
    =>below is the optimization step in implementing the safe method
    -------------------------------
    for left diagonal - i-j+n-1
    for right diagonal - i+j
*/
